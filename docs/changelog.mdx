...
<Update label="0.11.0" description="April 2026">
  ...
  **Breaking.** The convenience discovery wrappers were removed from the Node, browser, Rust, and Python SDKs:
  ...
  [Exec into a running worker &rarr;](/how-to/managing-container-workers#5-exec-into-a-running-worker)
  ...
  [Reproduce Worker Installs &rarr;](/how-to/reproduce-worker-installs)
